...
const section_banner = require('../assets/kinh_di.png');
const item_image_1 = require('../assets/dua_con_cua_thoi_tiet.jpg');
const item_image_2 = require('../assets/black_panner.jpg');
const item_image_3 = require('../assets/qua_tim_mau.jpg');
